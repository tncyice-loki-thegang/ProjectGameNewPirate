...
?>
	<title><?php echo $WebTitle?> - สมัครสมาชิก</title>
...
<body class="body_2" >
	...
	<div class="User_Panel bg-main float-right">		
		...
		<div class="margin float-right User_Xx">	
						<strong class="text-white">สมัครสมาชิก</strong>
			...
			<div class="form-group">
				...
				<div class="field">
					<input type="text" class="input" ID="Uname" name="Uname" placeholder="ชื่อผู้ใช้" data-validate="required:กรุณากรอกชื่อผู้ใช้,username:ต้องขึ้นต้นด้วยตัวอักษร,length#>5:ชื่อผู้ใช้ต้องมีความยาวไม่น้อยกว่า 6 ตัวอักษร" />
					<div class="tips"></div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="field">
					<input type="password" class="input" ID="Scode" name="Scode" placeholder="รหัสยืนยัน" data-validate="required:กรุณากรอกรหัสยืนยัน,length#>5:รหัสยืนยันต้องมีความยาวไม่น้อยกว่า 6 ตัวอักษร" />
					<div class="tips"></div>
				</div>
			</div>
			<div class="form-group">
				<div class="label"></div>
				<div class="field">
					<button class="button bg-main icon-check-square-o" type="button" onclick="Ajax_Action('Register')"  >สมัครสมาชิก</button></div>
			</div>
			</form>
			</div>	
		</div>
