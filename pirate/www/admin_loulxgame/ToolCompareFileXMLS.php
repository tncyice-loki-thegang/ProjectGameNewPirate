								...
								<FORM id="formAdmin" name="formAdmin" action="" method="post">
									...
									<div class="special">
											...
											echo "<div class='toolCampare'>";
												echo "<div style='width:71%'>";
													echo "<div class='title'>";
														$noteLanguage = getLanguageByKey('TOOL_COMPARE_FILE_XMLS_NOTE');
														echo "<p>{$noteLanguage}</p>";
													echo "</div>";
													echo "<div class='noteToolCompareBottom'>";
														echo "<div style='height:5px'></div>";
														$noteLanguage1 = getLanguageByKey('TOOL_COMPARE_FILE_XMLS_NOTE_1');
														echo "{$noteLanguage1}";
														echo "<br/>";
														$noteLanguage2 = getLanguageByKey('TOOL_COMPARE_FILE_XMLS_NOTE_2');
														echo "{$noteLanguage2}";
														echo "<br/>";
														$noteLanguage3 = getLanguageByKey('TOOL_COMPARE_FILE_XMLS_NOTE_3');
														echo "{$noteLanguage3}";
														echo "<br/>";
													echo "</div>";
												echo "</div>";
										...
										<div class="btn-group" style="width:50%">
											<button style="width:100%" type="submit" class="brk-btn" name="runToolXMLS" value="runToolXMLS">
												<?php
													$runToolXMLS = getLanguageByKey('TOOL_COMPARE_FILE_XMLS_BTN_RUN');
													echo "{$runToolXMLS}";
												?>
											</button>
										</div>
										...
										<div class="frameInfo">
											...
											<div style="width: 1000px; height:520px">
												...
												<div class='scroll' style='width:90%'>
													<?php
														require_once 'function/ToolCompareFileXMLSData.php';
													?>
												</div>
											</div>
										</div>
