...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--===============================================================================================-->
		...
		<link type="text/css" rel="stylesheet" href="css/main_admin_cp_custom_send_all_server.css" />
				...
				<div class="MainContent">
					<div class="containerMain">
						<div id="banner">
							...
							<div class="Banner_Left_Bottom" style="top: 612px"></div>
							<div class="Banner_Right_Top"></div>
							<div class="Banner_Right_Bottom" style="top: 612px"></div>
							<div style="width: 1000px; height:859px">
								<FORM id="formAdmin" name="formAdmin" action="" method="post">
									...
									<div class="special">
										<?php
											...
											require_once 'function/DatabaseManagerCustomSendAllServer.php';
										?>
									</div>
								</FORM>
							</div>
