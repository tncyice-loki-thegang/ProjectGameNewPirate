...
interface IPet
{
	 ...
	 * 
	 * @return int 								重生成功, 返回重生后训练开始时刻（0 的时候表示没有开始训练）
	 *         string 'err'						重生失败 
	 */
	function reborn($petID);
	 ...
	 * 突飞
	 * 
	 * @return string 'ok'						突飞成功
	 *         		  'err'						突飞失败 
	 */
	function rapid($petID);

	/**
	 * 金币突飞
	 * 
	 * @return string 'ok'						金币突飞成功
	 *         		  'err'						金币突飞失败 
	 */
	function rapidByGold($petID);
	 ...
	 * @param int $petID						宠物ID
	 * 
	 * @return string 'ok'						进化成功
	 */
	function evolution($petID);
	 ...
	 * @return array 							背包信息
	 */
	function feedingOnce($petID, $itemTID);
	 ...
	 * }
	 */
	function feedingAll($petID);

	/**
	 * 开启新的仓库格子
	 *  
	 * @return string 'ok'						开启格子成功
	 */
	function openWarehouseSlot();

	/**
	 * 将宠物放入仓库
	 * 
	 * @return string 'ok'						放到仓库成功
	 */
	function putInWarehouse($petID);

	/**
	 * 将宠物从仓库取出
	 * 
	 * @return string 'ok'						仓库取出成功
	 */
	function getOutWarehouse($petID);
	...
	function degenerateToEgg($petID);
