...
class UserPropertyTest extends PHPUnit_Framework_TestCase
{
	private $user;
	private $task;
	private $uid;
...
//		var_dump($newAccept);
	...
	public function test_checkModify_0()
	{
		...
		$va_task = array("type"=>TaskDataType::USER_PROPERTY, "key"=>1, "value"=>20);
...
//		$this->assertEquals(TaskStatus::CAN_SUBMIT, $task['status']);
//		
//		$va_task = array("type"=>TaskDataType::USER_PROPERTY, "key"=>1, "value"=>40);
//		$this->assertSame($va_task, $task['va_task'][0]);
//	}
//	
//	/**
