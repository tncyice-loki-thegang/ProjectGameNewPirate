...
class BeatArmyLevelTest extends PHPUnit_Framework_TestCase
{
	private $user;
	private $task;
	private $uid;
...
//		var_dump($newAccept);
	...
	public function test_checkModify_0()
	{
		...
		$armyId = 10004;
		TaskNotify::beatArmy($armyId, 'S');
//		$buf = TaskManager::getInstance()->getDataBuf();
//		var_dump($buf);
		...
		$va_task = array("type"=>TaskDataType::BEAT_ARMY_LEVEL, "key"=>$armyId, "value"=>1);
	...
	public function test_checkModify_1()
	{
		...
		$va_task = array("type"=>TaskDataType::BEAT_ARMY_LEVEL, "key"=>$armyId, "value"=>2);
		//$this->assertEquals(TaskS, $actual)
		$this->assertSame($va_task, $task['va_task'][0]);
	}
