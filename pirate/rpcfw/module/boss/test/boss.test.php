 ...
 * $Id: boss.test.php 16423 2012-03-14 02:57:27Z HaopingBai $
 *
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/module/boss/test/boss.test.php $
...
function main()
{
	...
	$proxy->setClass('boss');
	Test($proxy, 'enterBossCopy', array(15, 0, 0));
	Test($proxy, 'inspire', array());
	Test($proxy, 'inspireByGold', array());
	Test($proxy, 'attack', array(15));
	Test($proxy, 'revive', array(15));
	Test($proxy, 'leaveBossCopy', array());
	Test($proxy, 'enterBossCopy', array(15, 0, 0));
	Test($proxy, 'leaveBossCopy', array());
