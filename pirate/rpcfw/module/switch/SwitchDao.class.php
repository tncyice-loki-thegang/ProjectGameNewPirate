 ...
 * $Id: SwitchDao.class.php 16423 2012-03-14 02:57:27Z HaopingBai $
 * 
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/module/switch/SwitchDao.class.php $
...
class SwitchDao
{
	...
	public static function insert($uid, $arrField)
	{
		$data = new CData();
		$arrField['uid'] = $uid;
		$ret = $data->insertIgnore(self::tblName)->values($arrField)->query();
	}
