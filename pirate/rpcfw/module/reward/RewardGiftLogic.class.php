 ...
 * $Id: RewardGiftLogic.class.php 17254 2012-03-24 06:23:49Z HongyuLan $
 * 
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-0-26/module/reward/RewardGiftLogic.class.php $
...
class RewardGiftLogic
{
	...
	public static function getRewardGift($id, $step)
	{
		...
		$arrRet['reward']  = RewardUtil::reward($gift['uid'], $rewardId);		
