 ...
 * $Id: goodWillItem.script.php 23295 2012-07-05 06:59:45Z HongyuLan $
 *
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/module/item/scripts/goodWillItem.script.php $
...
ItemDef::ITEM_ATTR_NAME_GOOD_WILL_TYPE						=>		14,
ItemDef::ITEM_ATTR_NAME_GOOD_WILL							=>		15,
...
while ( TRUE )
{
	...
	$goodWillItems[$array[ItemDef::ITEM_ATTR_NAME_ITEM_TEMPLATE_ID]] = $array;
}
fclose($file);

$file = fopen($argv[2], 'w');
fwrite($file, serialize($goodWillItems));
fclose($file);
