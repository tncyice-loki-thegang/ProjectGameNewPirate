 ...
 * $Id: peteggItem.script.php 37627 2013-01-30 07:52:44Z yangwenhai $
 *
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/module/item/scripts/peteggItem.script.php $
...
ItemDef::ITEM_ATTR_NAME_PET_TEMPLATE_ID						=>		14,					//宠物模板ID
ItemDef::ITEM_ATTR_NAME_PET_LEVEL_LIMIT						=>      15,					//等级限制
ItemDef::ITEM_ATTR_NAME_PET_EGG_TYPE						=>		16,
ItemDef::ITEM_ATTR_NAME_DAIMONAPPLE_DONATION				=>		17,
);
...
while ( TRUE )
{
	...
	//use info
	$lvlimit=$array[ItemDef::ITEM_ATTR_NAME_PET_LEVEL_LIMIT];
	$array[ItemDef::ITEM_ATTR_NAME_USE_INFO] = array(
		ItemDef::ITEM_ATTR_NAME_USE_PET_TEMPLATE_ID=>$array[ItemDef::ITEM_ATTR_NAME_PET_TEMPLATE_ID],
		ItemDef::ITEM_ATTR_NAME_USE_REQ_USER_LEVEL=>array($lvlimit,UserConf::MAX_LEVEL+1 ));//把等级限制加上
	unset($array[ItemDef::ITEM_ATTR_NAME_PET_TEMPLATE_ID]);
	unset($array[ItemDef::ITEM_ATTR_NAME_PET_LEVEL_LIMIT]);
