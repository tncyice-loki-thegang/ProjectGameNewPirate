 ...
 **************************************************************************/
 ...
 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/trunk/pirate/rpcfw/module/user/script/genRandomNameSql.php $
 * @author $Author: HongyuLan $(lanhongyu@babeltime.com)
 * @date $Date: 2012-11-13 16:34:35 +0800 (星期二, 13 十一月 2012) $
...
$arrMan = readName($inputPath . '/random_name_man_hefu.csv');
$arrWoman = readName($inputPath . '/random_name_woman_hefu.csv');
...
$handle = fopen('insert_random_name_hefu.sql', 'w') or die('fail to open file');
