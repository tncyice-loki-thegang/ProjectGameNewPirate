 ...
 * $Id: town.test.php 16423 2012-03-14 02:57:27Z HaopingBai $
 *
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/module/city/test/town.test.php $
...
function main()
{
	...
	###move in Town###
	Test($proxy, 'moveInTown', array(15));

	###enter Town###
	//Test($proxy, 'enterTown', array(1, 1, 1));
	Test($proxy, 'enterTown', array(15,1,1));

	###leave Town###
	Test($proxy, 'leaveTown', array());

	###enter Town List###
	Test($proxy, 'enterTownList', array());
}
