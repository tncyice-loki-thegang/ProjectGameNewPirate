 ...
 * $Id: MailGemItemDelivery.class.php 24668 2012-07-25 01:50:45Z HaidongJia $
 *
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/script/MailGemItemDelivery.class.php $
 ...
 * 通过邮件发送指定经验的宝石
 *
 * @example btscript MailGemItemDelivery.class.php 51846 娜芙亚琪娜 40001 10
 *
 * @author pkujhd
 *
 */
class MailGemItemDelivery extends BaseScript
{
	/* (non-PHPdoc)
	...
	protected function executeScript ($arrOption)
	{
		...
		{
			echo "MailItemDelivery need three arguments: uid uname item_template_id exp\n";
			return;
		}
