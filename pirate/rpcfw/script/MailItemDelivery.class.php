 ...
 **************************************************************************/
 ...
 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/pirate/rpcfw/rpcfw_1-0-21-57/script/MailItemDelivery.class.php $
 ...
 * 通过邮件发送指定物品
 *
 * @example btscript MailItemDelivery.class.php 51846 娜芙亚琪娜 10001
 *
 * @author pkujhd
 *
 */
class MailItemDelivery extends BaseScript
{
	/* (non-PHPdoc)
